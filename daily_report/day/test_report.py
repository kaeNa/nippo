...
class ReportTest(TestCase):
    ...
    def post_request(self):
        ...
        request.POST['title'] = self.title
        request.POST['content_Y'] = self.content_Y
        request.POST['content_W'] = self.content_W
        request.POST['content_T'] = self.content_T
    ...
    def test_report_add(self):
        ...
        Client().login(username=self.user_id, password=self.password)
        print(Report.objects.all().count())

        # report = Report.objects.get(user=self.user)
        report = report_edit(self.post_request(), None)
        print(Report.objects.all().count())
        # print(report)
